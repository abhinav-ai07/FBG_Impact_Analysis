...
## Overview
This document provides quantitative comparison and physical engineering interpretations for the 13 extracted signal features across Bare (FBG1), Copper (FBG2), and Steel (FBG3) packaging conditions.
...
```text
Bare FBG  --> Direct Fiber-Host Contact --> Unattenuated Strain Transfer --> High Peak Shift
Copper    --> Intermediate Compliant Layer --> Stress Redistribution & Damping --> Moderate/High Shift
Steel     --> High Elastic Modulus Packaging --> Structural Load Sharing --> Reduced Effective Strain Transfer
```
