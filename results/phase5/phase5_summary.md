...
- **Material Mapping**: FBG2 -> Bare, FBG1 -> Copper, FBG3 -> Steel.
...
## 4. Key Findings
1. **Bare FBG (FBG2)** exhibits the highest overall impact sensitivity, largest peak shift (0.0298 nm), and highest dynamic signal energy due to direct unattenuated strain transfer.
2. **Copper Packaging (FBG1)** acts as a compliant packaging layer, redistributing strain and absorbing peak impact energy (0.0078 nm peak shift).
3. **Steel Packaging (FBG3)** provides maximum mechanical protection and high stiffness, distributing applied loads and producing smaller strain shifts (0.0028 nm peak shift).
